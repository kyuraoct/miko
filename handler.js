...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'oops x_x, this is only for kyura, not for stupid like u, ehe.',
        owner: 'oops x_x, this is only for kyura, not for stupid like u, ehe.',
        mods: 'oops x_x, this is only for miko moderators, not for stupid like u, ehe.',
        premium: '*Premium*\n1 Months *IDR 10.000*\n1 Years *IDR 90.000*\n\nHubungi *owner* kami..', 
        banned: 'this feature is for people who got banned',
        group: 'Perintah ini hanya dapat digunakan di grup!',
        private: 'This feature is used in private chat, not here',
        admin: 'This command is only for *Admin* group!',
        botAdmin: 'why u so stupid, make this bot an admin to use it',
